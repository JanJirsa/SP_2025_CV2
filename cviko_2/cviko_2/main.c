...
// Jednoduch� v�pis v�ech aut (aby bylo vid�t indexy)
void vypisAuta() {
...
// Smaz�n� auta podle indexu (posun zbytku doleva)
void smazAuto() {
    if (kartoteka.head.pocet_aut == 0) {
...
int main() {
    printf("tralala");
    // toto je pokusn� komentar
    // Inicializace kartot�ky
